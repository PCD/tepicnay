...
To use these stylesheets, rename the files and tepicnay with the name of your theme.
...
tepicnay-alpha-default-narrow.css  
...
tepicnay-alpha-default-normal.css
...
tepicnay-alpha-default-wide.css
